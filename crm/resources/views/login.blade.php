				...
				<form class="login100-form validate-form" method="POST" action="{{ route('login.post') }}">
                  @csrf
					<span class="login100-form-title">
						Sisteme Erişebilmek İçin Giriş Yapın !
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Lütfen E-Posta Adresinizi Giriniz.">
					...
					<div class="wrap-input100 validate-input" data-validate = "Paralonızı Giriniz">
