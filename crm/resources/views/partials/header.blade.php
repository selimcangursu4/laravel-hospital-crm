            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
                    ...
                    <div class="dropdown-menu-footer">
                        <a href="#" class="text-muted">Tüm Bildirimleri Gör</a>
                    </div>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                    <div class="dropdown-menu-header">
                        <div class="position-relative"> 4 Yeni Mesaj </div>
                    </div>
                    <div class="list-group">
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                    ...
                    <div class="dropdown-menu-footer">
                        <a href="#" class="text-muted">Tüm Mesajları Görüntüle</a>
                    </div>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                    data-bs-toggle="dropdown">
                    <img src="{{ asset('img/no-profile.webp') }}" class="avatar img-fluid rounded me-1"
                        alt="Charles Hall" />
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#">
                        <i class="align-middle me-1" data-feather="help-circle"></i> Mesajlarım </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="javascript:void(0)" id="logoutBtn">Güvenli Çıkış</a>
...
document.getElementById('logoutBtn').addEventListener('click', function () {
    Swal.fire({
        ...
        text: 'Oturumdan çıkmak üzeresiniz.',
        icon: 'warning',
